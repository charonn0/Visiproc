...
Begin Window setswin
   ...
   Begin PushButton PushButton1
      ...
      ButtonStyle     =   0
      Cancel          =   ""
      Caption         =   "Clear Current Backdrop"
      Default         =   ""
      Enabled         =   True
      Height          =   22
      HelpTag         =   ""
	...
	#tag Event
		Sub Open()
		  ...
		  For i As Integer = 0 To fonts.Ubound
		    Me.AddRow(fonts(i))
		    if fonts(i) = Globals.gTextFont Then
		      default = i// - 1
		    end if
		  Next
...
#tag Events textSize
	...
	#tag Event
		Sub Change()
		  //If Me.ListIndex <> 0 Then StringSize = Val(Me.Text)
		End Sub
	#tag EndEvent
#tag EndEvents

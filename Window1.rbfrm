...
#tag WindowCode
	...
	#tag MenuHandler
		Function sixteen() As Boolean Handles sixteen.Action
			ICOSize = 16
			dragContainer1.Update(True)
			Return True
	...
	#tag MenuHandler
		Function sixtyfour() As Boolean Handles sixtyfour.Action
			ICOSize = 64
			dragContainer1.Update(True)
			Return True
	...
	#tag MenuHandler
		Function thirtytwo() As Boolean Handles thirtytwo.Action
			ICOSize = 32
			dragContainer1.Update(True)
			Return True
